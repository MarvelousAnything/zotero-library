...
(function( window, $, undefined ) {
	...
	function buildGalleries( index, element ) {
		...
		if ( 0 === $galleryItems.length ) {
			$galleryItems = $galleryObj.find( 'li a' );
		}
	...
	function findGalleries() {
		var $gallery = $body.find( '.gallery, .tiled-gallery, .rslides' );
	...
	function addCaptions() {
		$.featherlight.prototype.afterContent = function() {
			var object    = this.$instance,
				...
				rslidesParent = target.parents( '.rslides li' );
			...
			} else if ( 0 !== rslidesParent.length ) {
				caption = rslidesParent.find( '.rslides_caption' );
			}
